...
class GymFacilitiesPage extends StatefulWidget {
  const GymFacilitiesPage({Key? key}) : super(key: key);

  @override
  State<GymFacilitiesPage> createState() => _GymFacilitiesPageState();
}

class _GymFacilitiesPageState extends State<GymFacilitiesPage> {
  String selectedFilter = 'Gym';
